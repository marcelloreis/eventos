	...
	**/	
	...
	$('a#open-growl-1').click(function(e){
		 $.e_notify.growl({
			 ...
			 image: $('meta[name=base_url]').attr('content') + 'img/growl-1.jpg',
			 position: 'right-top',
			 delay: 0,
			 time: 2500,
			 speed: 400,
	...
	$('a#open-growl-2').click(function(e){
		 $.e_notify.growl({
			 ...
			 image: $('meta[name=base_url]').attr('content') + 'img/growl-2.jpg',
	...
	$('a#open-loader-1').click(function(e){
		$.e_notify.loader({
			 image: $('meta[name=base_url]').attr('content') + 'img/loaders/type2/light/32.gif',
			 position: 'center',
			 imageSize: '32 | 32',
			 delay: 0,
			 time: 1200,
	...
	$('a#open-loader-2').click(function(e){
		$.e_notify.loader({
			 image: $('meta[name=base_url]').attr('content') + 'img/loaders/type4/light/56.gif',
			 position: 'right-bottom',
			 imageSize: '56 | 19',
			 delay: 0,
			 time: 2000,
	...
	$('a#open-notification-3').click(function(e){
		 $.e_notify.notification({
			 text: '<img src="' + $('meta[name=base_url]').attr('content') + 'img/icons/dialogs/plus-16.png" alt=""/> Yes you can add a notification to a target!',
			 position: 'top',
			 target: '#widget2 > div',
			 delay: 0,
			 time: 2500,
